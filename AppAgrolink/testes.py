...
def main():
    ...
    #criar_relatorio("Relatório Anual", "Descrição detalhada", r"C:\Users\nunon\Desktop\TesteImagem\images.jpg", 1)
    
    # Para testar localmente, inicie o servidor:
    if __name__ == '__main__':
        app.run(debug=True)


    #caminho_imagem = r"C:\Users\nunon\Desktop\TesteImagem\images.jpg"
